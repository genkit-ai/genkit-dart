...
abstract class $Subject {
  @Field(defaultValue: 'banana')
  String get subject;
}

@Schema()
abstract class $Count {
  @IntegerField(defaultValue: 5)
  int get count;
}
...
void main() async {
  ...
  final basic = ai.defineFlow(
    name: 'basic',
    inputSchema: .string(defaultValue: 'hi'),
    outputSchema: .string(),
  ...
  ai.defineFlow(
    name: 'parent',
    outputSchema: .string(defaultValue: 'hi'),
    fn: (_, _) async {
  ...
  ai.defineFlow(
    name: 'streamy',
    inputSchema: .integer(defaultValue: 5),
    outputSchema: .string(),
  ...
  ai.defineFlow(
    name: 'throwy',
    inputSchema: .string(defaultValue: 'banana'),
    outputSchema: .string(),
    fn: (subject, _) async {
      final foo = await ai.run('call-llm', () async {
        return 'subject: $subject';
