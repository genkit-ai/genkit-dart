...
extension type GenerationConfig._(Map<String, Object?> _data) {
  ...
  Object? get responseJsonSchema { final v = _data['responseJsonSchema']; if (v == null) return null; return v; }
  ...
  ImageConfig? get imageConfig { final v = _data['imageConfig']; if (v == null) return null; return ImageConfig._(v as Map<String, Object?>); }
  set imageConfig(ImageConfig? value) => _data['imageConfig'] = value;
...
extension type ImageConfig._(Map<String, Object?> _data) {
  ImageConfig({
    String? aspectRatio,
    String? imageSize,
  }) : this._({
  ...
  ImageConfig.fromJson(Map<String, dynamic> json) : this._(json);
  Map<String, dynamic> toJson() => _data as Map<String, dynamic>;

  String? get aspectRatio { final v = _data['aspectRatio']; if (v == null) return null; return v as String; }
  set aspectRatio(String? value) => _data['aspectRatio'] = value;
  String? get imageSize { final v = _data['imageSize']; if (v == null) return null; return v as String; }
  set imageSize(String? value) => _data['imageSize'] = value;
}
