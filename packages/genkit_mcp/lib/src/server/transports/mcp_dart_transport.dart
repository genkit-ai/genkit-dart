...
/// Adapts the existing Genkit server transport extension point to `mcp_dart`.
class McpDartServerTransport implements mcp.Transport {
  final McpServerTransport delegate;

  StreamSubscription<Map<String, dynamic>>? _subscription;
  bool _closed = false;

  McpDartServerTransport(this.delegate);
